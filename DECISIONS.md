...
**Mittarittoman kiinteistön kulutus (0026, kehitystoive 26.9.2026).** Muutamalla liittymällä ei ole mittaria. Niiltä laskutetaan kulutus henkilöluvun mukaan: henkilöluku kertaa organisaation kulutus asukasta kohden (Joutsa 40 m³ vuodessa, hinnaston 12,20 €/asukas/kk). Jos kiinteistölle on kirjattu sovittu vuosikulutus (arvioitu vuosikulutus), se ohittaa henkilöluvun. Näin katetaan myös vanhojen laskujen 30 m³:n puolivuotislasku. Laskulle tulee jakson kuukausien osuus vuosikulutuksesta ja lisätieto laskutavasta, ja rivi saa ei mittaria -tuotteen. Laskutapa koskee vain toteutuneen kulutuksen laskutusta. Arviolaskutuksessa vuosiarvio on jo laskun perusta, eikä Kärkisen tasausta haluttu muuttaa huomaamatta.


**Julkisen avaimen oikeudet pois (0027, 26.9.2026).** Supabase antaa roolille anon oletuksena kaikki oikeudet uusiin tauluihin ja funktioihin, ja migraatiokirjanpidolla `ml_schema_migrations` ei ollut RLS:ää. Julkisella avaimella olisi siis voinut lukea ja muuttaa kirjanpitoa. Ohjelma ei käytä julkista avainta, joten anonilta poistetaan kaikki oikeudet `ml_`-tauluihin, -sekvensseihin ja -funktioihin, ja kirjanpito on vain palvelun roolille. Paikallinen jäljitelmä antaa anonille samat oletusoikeudet kuin Supabase, jotta testi todistaa poiston. Sama korjaus tehtiin Skogiin.
