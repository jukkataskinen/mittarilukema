...
6. **Kirjautuminen (Auth0).** Päätetty: oma tenantti (DECISIONS 24.9.2026). Jukka luo tenantin ja sovelluksen (24.9.2026). Odottaa tunnuksia `.env.local`:iin ja Verceliin. Siihen asti tuotannossa ei voi kirjautua.
